    ...
    >
      ...
      {isCalled && (
        <div className="relative z-10 space-y-5 pt-4 motion-safe:animate-fadeIn">
          <div className="rounded-2xl border border-sky-400/50 bg-gradient-to-b from-sky-500/20 via-sky-600/15 to-blue-900/30 p-5 text-center space-y-3 shadow-xl shadow-sky-500/20">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-sky-400/20 hover:bg-sky-400/30 border border-sky-300/30 text-sky-200 text-xs font-bold transition-all"
            >
              <Volume2 className="h-4 w-4 text-sky-300" />
              <span>{buzzerTested ? 'Buzzer ringing! 🔊' : 'Ring Buzzer Again'}</span>
            </button>
          </div>
