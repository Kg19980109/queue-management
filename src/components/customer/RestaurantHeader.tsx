  ...
  return (
    <div className="flex flex-col items-center text-center space-y-4 pt-4 pb-2">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 pt-1 text-xs">
        {restaurant.address && (
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full glass-panel-subtle text-slate-300">
        ...
        {restaurant.queueEnabled ? (
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 font-medium">
            🛑 Queue Closed
          </span>
        )}
