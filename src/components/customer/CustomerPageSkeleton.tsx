...
export function CustomerPageSkeleton() {
  return (
    <div
      ...
      role="status"
      className="mx-auto flex min-h-[100dvh] w-full max-w-md flex-col gap-5 bg-slate-950 px-4 py-6 sm:py-8"
    >
      ...
      <div className="h-28 animate-pulse rounded-3xl border border-white/5 bg-slate-900" />
      <div className="h-96 animate-pulse rounded-3xl border border-white/5 bg-slate-900" />
      <div className="h-24 animate-pulse rounded-2xl border border-white/5 bg-slate-900" />
